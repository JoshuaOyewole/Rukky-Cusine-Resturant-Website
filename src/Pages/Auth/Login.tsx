...
const Login = () => {
  ...
  return (
    <section className="w-full h-auto mb-12">
        ...
        <div className="flex justify-center items-center flex-wrap h-full g-3 text-gray-800">
          ...
          <div className="w-full md:w-[30rem]">
            <form className="p-2">
              ...
              <motion.p
                className="cursor-pointer flex items-center justify-center px-7 py-3 bg-gradient-to-br from-[#f65f28] to-[#BC3908] text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:bg-[#f65f28] hover:shadow-lg focus:bg-[#f65f28] focus:shadow-lg focus:outline-none focus:ring-0 active:bg-[#40476D] active:shadow-lg transition duration-150 ease-in-out w-full"
                onClick={EmailAuth}
