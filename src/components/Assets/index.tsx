...
import TestifierI from "../../img/testifier.jpg"; 
import TestifierII from "../../img/testifier2.jpg"; 
...
export const AboutImg = AboutI
export const Testifier1 = TestifierI
export const Testifier2 = TestifierII